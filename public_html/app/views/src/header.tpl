<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="/public/dist/images/favicons/favicon-16x16.png">
    <link rel="manifest" href="/public/dist/site.webmanifest">
    <link rel="mask-icon" href="/public/dist/images/favicons/safari-pinned-tab.svg" color="#4d8df9">
    <meta name="msapplication-TileColor" content="#4d8df9">
