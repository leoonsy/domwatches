<section id="section-top" class="parallax-window" data-parallax="scroll" data-image-src="/public/dist/images/bg-top.jpg" data-speed="-0.1" data-position="bottom right">
	<div class="container h-100 d-flex align-items-center" data-aos="fade-in" data-aos-offset="150" data-aos-duration="1000">
		<div class="top-info">
			...
			<p class="top-info__desc-2">Стильные, устойчивые к царапинам водонепроницаемые часы DOM прослужат вам многие годы и подчеркнут вашу индивидуальность!</p><a class="top-info__buy" href="#section-goods" role="button">Выбрать часы</a></div>
	</div>
</section>
	...
	<div class="container">
		<div class="row advant">
			<div class="col-lg-12 advant__header" data-aos="fade-in" data-aos-offset="150" data-aos-duration="1000">
				<h3 class="advant__header-text">ПРЕИМУЩЕСТВА ЧАСОВ</h3><img src="/public/dist/images/hr/main.png" class="advant__hr" alt="Разделитель"></div>
	...
	<div class="container" data-aos="fade-in" data-aos-offset="150" data-aos-duration="1000">
		<div class="row characters">
			<div class="col-lg-12 characters__header">
				<h3 class="characters__header-text">ХАРАКТЕРИСТИКИ ЧАСОВ</h3><img src="/public/dist/images/hr/main.png" class="characters__hr" alt="Разделитель"></div>
			<div class="col-lg-6 characters__carousel">
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active"><img class="d-block w-100" src="/public/dist/images/carousel-characters/0.jpg" alt="M-635L-1M9">
							<div class="carousel-caption d-none d-md-block">
								<h3>M-635D-1M9</h3></div>
						</div>
						<div class="carousel-item"><img class="d-block w-100" src="/public/dist/images/carousel-characters/1.jpg" alt="M-635BK-1M">
							<div class="carousel-caption d-none d-md-block">
								<h3>M-635BK-1M</h3></div>
						</div>
						<div class="carousel-item"><img class="d-block w-100" src="/public/dist/images/carousel-characters/2.jpg" alt="M-635L-1M9">
							<div class="carousel-caption d-none d-md-block">
								<h3>M-635L-1M9</h3></div>
						</div>
						<div class="carousel-item"><img class="d-block w-100" src="/public/dist/images/carousel-characters/3.jpg" alt="M-635L-7M">
							<div class="carousel-caption d-none d-md-block">
								<h3>M-635L-7M</h3></div>
						</div>
					</div><a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span> </a><a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span></a></div>
			</div>
	...
	<div class="container">
		<div class="discount">
			<div class="discount__left" data-aos="fade-right" data-aos-offset="150" data-aos-duration="1000">
				...
				<h3 class="discount__amount">на часы <b>M-635L-1M9</b> в размере <b>50%</b></h3>
				<div class="price">
					...
					<div class="price__number">
						<div class="price__number-old">3154₽</div>
						<div class="price__number-new">1577₽</div>
					</div>
				</div>
				<p class="discount__end">До конца акции осталось:</p>
				<div class="flipper discount__timer" data-datetime="2020-01-19 00:00:00" data-template="ddd|HH|ii|ss" data-labels="Дней|Часов|Минут|Секунд" data-reverse="true" id="myFlipper"></div><a class="discount__button" href="/buy">Заказать со скидкой</a></div>
...
<section id="section-goods">
	<div class="container goods" data-aos="fade-left" data-aos-offset="150" data-aos-duration="1000">
		<div class="goods__header">
			<h3>ЧАСЫ DOM</h3><img src="/public/dist/images/hr/main.png" class="characters__hr" alt="Разделитель"></div>
		<div class="row goods__content text-lg-left text-center">
			<div class="col-lg-3 goods__item">
				<div class="goods__item-content">
					<div class="goods__img"><img src="/public/dist/images/watches/0.png" alt="M-635L-1M9"></div>
					<div class="goods__discount goods__discount--few"><span>СКИДКА 40%</span></div>
					...
					<div class="mt-auto">
						...
						<div class="goods__price">
							<div class="goods__price-old">2795₽</div>
							<div class="goods__price-new">1677₽</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-3 goods__item">
				<div class="goods__item-content">
					<div class="goods__img"><img src="/public/dist/images/watches/1.png" alt="M-635BK-1M"></div>
					<div class="goods__discount goods__discount--few"><span>СКИДКА 40%</span></div>
			...
			<div class="col-lg-3 goods__item">
				<div class="goods__item-content">
					<div class="goods__img"><img src="/public/dist/images/watches/2.png" alt="M-635L-1M9"></div>
					<div class="goods__discount"><span>СКИДКА 50%</span></div>
					...
					<div class="mt-auto">
						<hr class="goods__item-separator">
						<div class="goods__price">
							<div class="goods__price-old">3154₽</div>
							<div class="goods__price-new">1577₽</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-3 goods__item">
				<div class="goods__item-content">
					<div class="goods__img"><img src="/public/dist/images/watches/3.png" alt="M-635L-7M"></div>
					...
					<div class="mt-auto">
						<hr class="goods__item-separator">
						<div class="goods__price">
							<div class="goods__price-new">Нет в наличии</div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="goods__buy"><a href="/buy" class="goods__button">Заказать часы</a></div>
</section>
<section id="section-why-we">
	<div class="container why-we" data-aos="fade-in" data-aos-offset="150" data-aos-duration="1000">
		<div class="why-we__header">
			<h3>ПОЧЕМУ МЫ?</h3><img src="/public/dist/images/hr/main.png" class="characters__hr" alt="Разделитель"></div>
		<div class="why-we__content">
			<div class="row why-we__main">
				<div class="col-lg-6 mb-3">
					<div class="why-we__item"><img src="/public/dist/images/icons/why-we/air.png" alt="Самолет">
				...
				<div class="col-lg-6 mb-3">
					<div class="why-we__item"><img src="/public/dist/images/icons/why-we/r.png" alt="Рубль">
				...
				<div class="col-lg-6 mb-3">
					<div class="why-we__item"><img src="/public/dist/images/icons/why-we/support.png" alt="Письмо">
				...
				<div class="col-lg-6 mb-3">
					<div class="why-we__item why-we__item-last"><img src="/public/dist/images/icons/why-we/lock.png" alt="Замок">
...
<section id="section-how-works">
	<div class="container how-works" data-aos="flip-up" data-aos-offset="150" data-aos-duration="1000">
		<div class="how-works__header">
			<h3>КАК ПОЛУЧИТЬ ЧАСЫ</h3><img src="/public/dist/images/hr/question.png" class="characters__hr" alt="Разделитель"></div>
		...
		<div class="how-works__sequence-mobile row">
			<div class="how-works__basket-mobile col-sm"><img src="/public/dist/images/icons/how-works/1.png" alt="Наручные часы">
				<p>Вы выбираете понравившиеся часы</p>
			</div>
			<div class="how-works__form-mobile col-sm"><img src="/public/dist/images/icons/how-works/2.png" alt="Сообщение">
				<p>Оставляете заявку через форму заявки на сайте</p>
			</div>
			<div class="how-works__call-mobile col-sm"><img src="/public/dist/images/icons/how-works/3.png" alt="Телефон">
				<p>Мы перезваниваем Вам для подтверждения заказа</p>
			</div>
			<div class="how-works__send-mobile col-sm"><img src="/public/dist/images/icons/how-works/4.png" alt="Самолет">
				<p>Отправляем Ваш заказ в пункт назначения</p>
			</div>
			<div class="how-works__check-mobile col-sm"><img src="/public/dist/images/icons/how-works/5.png" alt="Кошелек">
	...
	<div class="container" data-aos="fade-left" data-aos-offset="150" data-aos-duration="1000">
		<div class="reviews">
			<div class="reviews__header">
				<h3>ОТЗЫВЫ</h3><img src="/public/dist/images/hr/rev.png" class="characters__hr" alt="Разделитель"></div>
			<div class="reviews__carousel">
				<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner reviews__inner">
						<div class="carousel-item active">
							<div class="reviews__item"><img src="/public/dist/images/reviews/1.jpg" class="reviews__avatar" alt="Матвей Гуляев">
						...
						<div class="carousel-item">
							<div class="reviews__item"><img src="/public/dist/images/reviews/2.jpg" class="reviews__avatar" alt="Артем Сазонов">
								<div class="reviews__text">
						...
						<div class="carousel-item">
							<div class="reviews__item"><img src="/public/dist/images/reviews/3.jpg" class="reviews__avatar" alt="Сергей Фомин">
								<div class="reviews__text">
